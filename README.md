...
# Домашнее задание № 8-10.

### **Д/з № 8**
Написать телефонный справочник, который работает с файлом формата .txt.
В него должны быть заложенны следующие функции:
    ...
    7. Удалить контакт
    8. Выход\n'''
Все должно быть реализовано в функциях, в одном файле.

### **Д/з № 9**
Модифицировать задание 8, разбив функционал по файлам.

### **Д/з № 9**
Модифицировать задание 9, создав класс и объекты.